...
load("Results/Simu/simulated_data/scientific_data.RData")
load("Results/Simu/simulated_data/latent_field.RData")
...
simu_file <- paste0("Results/Simu/",Version,"/",Version,"-",Start_time.tot_2,"_",simu_name,"/")
...
if(restart_after_crash == T){
  ...
  simu_file <- "Results/Simu/com_x_sci_data_14/com_x_sci_data_14-2020-08-29_11_59_26_Lognormal_Nsamp"
}
...
## loop
for(i in i0:n_sim){
  # for(n_samp_com in c(50,100,200,400,1500,3000)){
...
source("Scripts/Simulation/function/plot_simu.R")
...
# Save point for paper_1 
# save(file = "Rmd/Paper_1/Simu_zone.without.fishing.RData",data = Results)
...
# source("Scripts/Simulation/RelBias_param.R")
# # Results_loop file
# file <- "E:/outputs/Simulation/com_x_sci_data_10-2020-04-16_13_36_40_Alpha1_lognorm-Results_loop.RData"
# load(file)
