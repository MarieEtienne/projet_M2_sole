---
title: "Downscaling coarse observations to predict continuous species spatio-temporal distribution"
...
$$\operatorname{P}\left(D_j=d_{j} \vert d_j > 0 \right) = \quad \textbf{?}$$

### Specifying $\operatorname{P}\left(D_j=d_{j} \vert d_j > 0 \right)$

\normalsize

\textbf{Compute the moments}
...
\textbf{Consider $D_j$ is Lognormal too}
