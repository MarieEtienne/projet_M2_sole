...
\hypersetup{
  pdftitle={Can we use reallocated logbooks data to map species distribution habitats?},
...
\title{Can we use reallocated logbooks data to map species distribution habitats?}
...
\caption{\label{tab:unnamed-chunk-1}Percentage of convergence for each simulation/model configuration}
\centering
