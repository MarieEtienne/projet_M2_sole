...
\begin{equation}
\label{eq:defY}
Y_i | S(x_i)  \overset{ind}{\sim} \M{p_i}{\frac{S(x_i)}{1-p_i}}{\sigma^2}
\end{equation}

\begin{align}
Y_i | S(x_i) & \overset{ind}{\sim} p_i \delta_0+ (1-p_i) B_i, \quad B_i \sim \mathcal{L}\left ( \frac{S(x_i)}{1-p_i} ,\sigma^2\right), \cr \nonumber
\mbox{with } p_i &= \exp(-e^\xi S(x_{i}))
\end{align}
