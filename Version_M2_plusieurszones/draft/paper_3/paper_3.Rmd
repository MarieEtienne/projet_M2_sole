...
- (2) modifiable areal unit problem (MAUP) when data are aggregated over large scales 


Several studies have tackled this issue; for instance, @gotway2002combining and @gelfand2010misaligned proposed extensive reviews on COS and how it can be handled in statistical modelling. @mugglin2000fully, @gelfand2001change, @gotway2007geostatistical, @wikle2005combining proposed generic approaches for adressing COS in spatial or spatio-temporal context. kim2016change extended the framework from @wikle2005combining to account for temporal modelling and time-varying parameters. In the context of health analysis, @young2007linking proposed to compare some standard (and rough) way to connect data that do not have the same spatial resolution with a method properly accounting for COS. berrocal2010bivariate and berrocal2010spatio proposed a spatio-temporal method for fusing several air pollution data: one from coarse resolution but with full spatial coverage and another recorded at point level, with sparse distribution but where records almost corresponds to the true value of the process. In climate science, downscaling is common practice and is usually realized by combining large scale with lower scale dynamic models; more recently, @reich2014spectral and @parker2015multiresolution proposed a spectral statistical approach to downscale information from large scale model to lower scales. The 

[@gotway2002combining,@gotway2007geostatistical,@young2007linking,@berrocal2010bivariate,@berrocal2010spatio,@ren2013hierarchical,@reich2014spectral,@parker2015multiresolution,@kim2016change,@pacifici2019resolving,@gilbert2021integrating]. Typically, 



It is recognized as a Broadly speaking, COS is 
