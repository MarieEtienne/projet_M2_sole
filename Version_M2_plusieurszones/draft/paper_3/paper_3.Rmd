...
\E\left ( Y_i \vert Y_i >0 , S(x_i)\right)  & =  \frac{S(x_i)}{1-p_i},\\  \nonumber
\V ar( \log{Y_i}\vert Y_i >0, S(x_i) )& = \mu_i^2 (e^{\sigma^2}-1), \cr \nonumber
\end{align}
...
XXXX  Il faut aussi présenter la partie commercial ou dire que c'est comme dans Alglave 2022
